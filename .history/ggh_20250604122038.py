...
class GGH:
    ...
    def encrypt(self, message:str) -> np.array:
        ...
        ciphertext = encoded @ self.public_key
        return ciphertext
    ...
    def decrypt(self, ciphertext:np.array) -> str:
        ...
        closest_vector = ciphertext @ np.linalg.inv(self.public_key)
        message = np.round(closest_vector)
...
message = "hello! how are you? i am very good!"
dim = len(message)
print("Dimension:", dim)
