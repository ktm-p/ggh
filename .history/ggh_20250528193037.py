...
class GGH:
    def __init__(self, dimension:int=2, sigma:int=3, thresh:int=1000):
        ...
        self.unimodular = Utils.generate_unimodular(self.dimension, 500)
...
dim = len(message)
inst = GGH(dimension=dim, sigma=3)
...
print("Hadamard Ratio:", Utils.hadamard_ratio(inst.dimension, inst.private_key))
print("\n")
