...
inst = GGH(dimension=3, sigma=3)
print("Public Key:", inst.public_key)
print("Hadamard Ratio:", Utils.hadamard_ratio(inst.public_key))
print("\n")
print("Private Key:", inst.private_key)
print("Hadamard Ratio:", Utils.hadamard_ratio(inst.private_key))
print("\n")
print("Unimodular:", inst.unimodular)
print("Is Unimodular?", Utils.check_unimodular(inst.unimodular))
